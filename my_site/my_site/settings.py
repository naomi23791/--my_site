...
SECRET_KEY = 'django-insecure-*_cnd)*(bl^y-h846g2gwh!i$9($sh5az_d)w^+towj_tp!b8#'
...
STATIC_URL = 'static/'
# Serve additional static directories (e.g., built-in avatar library)
STATICFILES_DIRS = [
...
# NOUVELLES CONFIGURATIONS POUR DRF - AJOUTÉES À LA FIN
...
# TODO: For production, use environment variables and a proper .env file